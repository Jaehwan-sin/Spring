...
public class BController {
	...
	//private static final Logger logger = LoggerFactory.getLogger(BController.class); /* 1 */
...
//		데이터 가져오기 작업
		//logger.info("logloglogloglog : " + request.getContextPath() + " : " + request.getLocalAddr()); /* 2 */
